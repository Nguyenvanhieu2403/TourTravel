                    ...
                    <form action="" method="post" id="booking-form">
                        <div class="booking-form-wrapper">
                            <div class="custom-input-group row">
                                <input type="text" placeholder="Your Full Name" id="name" name="fullNameBook" required>
                            </div>
                            <div class="custom-input-group row">
                                <input type="email" placeholder="Your Email" id="email" name="emailBook" required>
                            </div>
                            <div class="custom-input-group row">
                            <input type="tel" placeholder="Phone" id="phone" name="phoneBook" required>
                            </div>
                            <div class="custom-input-group position-relative row">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                                </svg>
                                <select id="ticket_type" name="ticketTypeBook" required>
                            ...
                            <div class="col-sm-6">
                                <div class="custom-input-group position-relative row">
                                    <input type="number" name="Adult" id="Adult" placeholder="Adult" min="0" required>
                                </div>  
                            </div>
                            <div class="col-sm-6">
                                <div class="custom-input-group position-relative row">
                                    <input type="number" name="Child" id="Child" placeholder="Child" min="0" required>
                                </div>  
                            </div>
                            </div>
                            <div class="custom-input-group  position-relative row">
                                <input placeholder="Select your date" type="date" name="checkIn" id="datepicker2" value="" class="calendar hasDatepicker" required>
                            </div>
                            <div class="custom-input-group pt-4">
                            <textarea cols="45" rows="6" placeholder="Your message" name="messageBook" required></textarea>
                            </div>
                            <div class="custom-input-group row">
...
<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["fullNameBook"])) {
        ...
        // $sqlComment->bind_param("iissssiis", $id, $fullNameComment, $emailComment, $tourTypeComment, $messageComment, $ratingComment, $statusComment, $dateCreateComment);
