...
<div class="manager_customer">
    <nav class="navbar navbar-expand-md navbar-light bg-light p-0 m-0">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 col-lg-2 col-xl-2">
                    <div class="dashboard">
                        <img class="img_dashboard" src="../../../user/assets/img/logo/logo-w.png" alt="">
                        <!-- Navbar for large screens -->
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="function list-inline">
                                <li>Dashboard
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-gear icon" viewBox="0 0 16 16">
                                ...
                                <li>Manager&nbsp;Customer
                                    ...
                                    <ul class="func_manager_customer list-inline">
                                        <li>Chờ duyệt</li>
                                        <li>Đã duyệt</li>
                                        <li>Đang đi</li>
                                        <li>Đã đi</li>
                                ...
                                <li>Manager&nbsp;Account
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-gear icon" viewBox="0 0 16 16">
                        ...
                        <!-- Navbar for small screens (offcanvas) -->
                        ...
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                            <div class="offcanvas-header">
                                <img src="../../../user/assets/img/logo/logo-w.png" alt="">
                ...
                <div class="col-md-10 col-lg-10 col-xl-10 bg-danger">
                    <h1>Test</h1>
                </div>
            </div>
        </div>
